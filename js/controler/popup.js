        ...
        function _findInfo(){
            ...
            chrome.tabs.getSelected( null, function( tab){
                ...
                APP.Ajax.setData({
                    ...
                    url    : APP.urlApi + 'page/info.json',
                    method : "POST"

                }, function( oData){

                    if( oData.status == 'success'){//connection OK
                        if( oData.message == 'not exist'){

                            APP.ctrlPage.setData( 'ajouter', 'parent', oPublic)
                                         .setData( 'ajouter', 'project', oData.data)
                                         .active( 'ajouter');
                        }else{
...
*****************************************************/
    ...
    APP.Popup.parent    = parent;
    APP.Popup.connect   = connect;
    APP.Popup.page      = page;
    APP.Popup.subscribe = subscribe;
